...
node tools\e2e\codex-smooth-switch.cjs         # 25 项：换条目/换类别不重建骨架 + 帧条"演完才收高度" + 滚字
```
...
# 起应用
node tools\e2e\codex-list-motion.cjs           # 17 项（A/B 改动前 15/17）
```
